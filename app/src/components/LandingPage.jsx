  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="border-t border-slate-800/60 px-6 py-4">
        <div className="max-w-6xl mx-auto flex flex-col items-center text-center text-xs text-slate-500">
          <div className="flex items-center gap-4">
            ...
            <span>Static site — no data leaves your browser · Portfolio demonstration · Generic framework, not professional advice</span>
          </div>
        </div>
      </div>
    </div>
